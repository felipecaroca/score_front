    ...
    <v-container>
      <v-layout>
        <v-flex class="text-sm-left">
          ...
          <br>
          <p>
            La presente Política de Privacidad establece los términos en que {{siteName}} usa y protege la
          ...
          <p>
            {{siteName}} está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos
          ...
          <p>
            {{siteName}} Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
            momento.
          </p>
        </v-flex>
      </v-layout>
